...
adata = sc.read_h5ad("clustering.h5ad")
...
sc.pl.umap(adata, 
           ...
           save="_anotacao_final.png")

#Dotplot para validar anotação

genes_validacao = ['IL7R', 'HBB', 'CDK6', 'BANK1', 'VCAN']

#Sem dendograma
sc.pl.dotplot(
    adata,
    var_names=genes_validacao,
    groupby='Cell_Type',
    standard_scale='var',
    cmap='Reds',
    save="_validacao_marcadores.png"
)

#Utilizando Dendograma para organizar melhor o dotplot
...
sc.pl.dotplot(
    ...
    cmap='Reds',
    dendrogram=True,
    save="_validacao_marcadores_dendogram.png",
    show=False
)


adata.write_h5ad("manual_annotation.h5ad", compression="gzip")
