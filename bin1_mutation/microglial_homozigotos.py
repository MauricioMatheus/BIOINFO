...
df_resultados.to_csv("bin1_mutation/resultados_expressao_diferencial_DESeq_homozigotos.csv")
...
plt.tight_layout()
plt.savefig("bin1_mutation/figures/homozigotos/Volcano_Plot_DESeq2_Cluster_DAM2.png", dpi=300, bbox_inches="tight")
plt.show()